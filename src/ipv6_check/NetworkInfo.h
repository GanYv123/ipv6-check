...
struct NetworkInterface {
    ...
    std::string                   hardwareType;    // 硬件类型，如 Ethernet, Wireless
    std::vector<IPv4AddressInfo>  ipv4Addresses;   // 绑定的 IPv4 地址列表
    std::vector<IPv6AddressInfo>  ipv6Addresses;   // 绑定的 IPv6 地址列表
